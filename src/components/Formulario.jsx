  ...
  return (
    ...
    onSubmit={handleSubmit}>
        ...
        <div className="mb-5">
            ...
            <input id="nombre" type="text" placeholder="Example ... Coco" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
            value={nombre}
        ...
        <div className="mb-5">
            ...
            <input id="propietario" type="text" placeholder="Example ... Pedro" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
            value={propietario}
        ...
        <div className="mb-5">
            ...
            <input id="email" type="email" placeholder="Example ... email@email.com" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
            value={email}
        ...
        <div className="mb-5">
            ...
            <textarea id="sintomas" placeholder="Example ... No come" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
            value={sintomas}
