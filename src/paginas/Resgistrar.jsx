        ...
        <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
            ...
            <form onSubmit={handleSubmit}>
                <div className="my-5">
                    ...
                    <input type="text" placeholder="Example... Adolf Hitler" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" 
                    value={nombre} 
                ...
                <div className="my-5">
                    ...
                    <input type="email" placeholder="Example... correo@gmail.com" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl"
                    value={email} 
                ...
                <div className="my-5">
                    ...
                    <input type="password" placeholder="Example...123$weEt" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl"
                    value={password} 
