...
const CambiarPassword = () => {
    ...
    const handleSubmit = async e => {
        ...
        if(password.pwd_nuevo.length < 6) {
            ...
            setAlerta({
                msg: 'El Password debe contener un mínimo de 6 carácteres',
                error: true
            })
            return
        }
            ...
            <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-3">
                        ...
                        <input type="password" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="pwd_actual" placeholder="Example...123$weEt"
                    ...
                    <div className="my-3">
                        ...
                        <input type="password" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="pwd_nuevo" placeholder="Example...123$weEt"
                        onChange={e => setPassword({
                            ...password,
                            [e.target.name] : e.target.value
                        })} />
